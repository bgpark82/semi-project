...
VALUES(4,S_NO ,TO_DATE('2018-12-24','YYYY-MM-DD') ,'8','제주도','동백습지 -> 한라산 -> 우도 -> 샤려니숲길',2,'100,000',SYSDATE,36.12345677,123.23124155)
WHERE U_NO = 4            S_NO = S_NO + 1;


INSERT INTO SCHEDULE_TABLE 
VALUES(5,SEQ,TO_DATE('2018-12-24','YYYY-MM-DD') ,'8','제주도','동백습지 -> 한라산 -> 우도 -> 샤려니숲길',2,'100,000',SYSDATE,36.12345677,123.23124155)
