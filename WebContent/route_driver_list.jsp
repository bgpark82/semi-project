...
<%@ include file="form/header.jsp" %>
								...
								<div class="col-xs-4" style="margin-top: 18px;">
     							...
     							<div>
									<!-- <label class="checkbox-inline"> -->
										<input type="button" value="선택" style="margin: 40% 0 0 60%;" class="btn btn-primary" id="${dto.d_no }" onclick="selectDriver(this)">
									<!-- </label> -->
								</div>
     						</div>
     						</div>    
	...
	<script>
		function selectDriver(chk){
			location.href="ScheduleController?command=payment&id="+$(chk).attr("id");
		};
	</script>
