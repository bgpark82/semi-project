...
<script type="text/javascript">
	...
	function idChkConfirm(){
		var chk = document.getElementsByName("u_id")[0].title;
		if(chk=="n"){
   ...
   <div class="jumbotron" style="width: 800px;">
      ...
      <form class="form-horizontal" action="UserController" method="post">
        ...
        <div class="form-group">
           <div class="col-sm-1"></div>
            ...
            <div class="col-sm-5">
                <input class="form-control" type="text" name="u_id" title="n" required="required">
             </div>
             <div class="col-sm-2" >
          ...
          <div class="form-group">
            ...
            <div class="col-sm-5">
                <input class="form-control" type="password" name="u_pw" onclick="idChkConfirm();" placeholder="비밀번호 입력" required="required">
             </div>
          </div>
          ...
          <!-- <div class="form-group">
            ...
            <div class="col-sm-5">
                <input class="form-control" type="password" name="pwd_check" onkeyup="checkPwd()" placeholder="비밀번호 확인" required="required">
         </div>   
         <div class="col-sm-4" style="padding-right: 0px;padding-left: 0px;">
            <a id="checkPwd" style="font-size: 15px" >비밀번호가 일치하지 않습니다.</a>
             </div>
          </div> -->
          ...
          <div class="form-group">
            ...
            <div class="col-sm-5">
                <input class="form-control" type="text" name="u_name" onclick="idChkConfirm();" required="required">
             </div>
      ...
      <div class="form-group">
            ...
            <div class="col-sm-5" style="margin-top: 6px;">
            	<input type ="radio"  name="u_gender" value="W" onclick="idChkConfirm();"> 여성
            	<input type ="radio"  name="u_gender" value="M" onclick="idChkConfirm();" style="margin-left: 30px;"> 남성
             </div>
          </div>
      ...
      <div class="form-group">
            ...
            <div class="col-sm-5">
                <input class="form-control" type="text" name="u_birth" onclick="idChkConfirm();" placeholder="ex) 940521" required="required">
             </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-5">
                <input class="form-control" type="text" name="u_phone" onclick="idChkConfirm();" placeholder="'-'은 제외하고 입력해주세요." required="required">
             </div>
          </div>
          ...
          <div class="form-group">
             ...
             <div class="col-sm-5">
                <input class="form-control" type="email" name="u_email" onclick="idChkConfirm();" placeholder="example@naver.com" required="required"/>
             </div>   
          </div>
...
로그인 기록: 3개월</textarea>        
          ...
          <div class="container">
	          <div class="form-group" >
	             ...
	             <div class="col-sm-6">
	                <button class="btn btn-default btn-block" type="button" onclick="location.href='user_registform.jsp'">가입취소</button>
	             </div>
	          </div>
          </div>
    </form>
