    ...
    function html5Upload() {	
    	...
    	sUploadURL= '/SemiProject/file_uploader_html5.jsp'; 	//upload URL
...
// 			sCallback : location.href.replace(/\/[^\/]*$/, '') + '/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
 			sUrl : '/SemiProject/file_uploader.jsp',								//파일업로드를 처리하는 페이지
 			sCallback : '/SemiProject/SE2/sample/photo_uploader/callback.html',		//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
